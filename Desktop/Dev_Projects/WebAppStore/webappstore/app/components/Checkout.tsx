...
const CheckoutForm = (item: any) => {
   ...
   // if there are items in cart calculate the total price
    ...
    return (<div>
        ...
        <div className="grid sm:grid-cols-1 lg:grid-cols-1 w-full p-5">
            <div className="px-4 pt-8">
                <h1 className="text-2xl font-medium">Order Summary</h1>
                <p className="text-black">Check your items. And select a suitable shipping method.</p>
                {sharedState ? sharedState.map((item: any) => (
                    <div key={item.id} className="mt-8 overflow-scroll space-y-3 rounded-lg border px-2 py-4 sm:px-6">
                    ...
                    <div className="relative">
                        ...
                        <label className="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" htmlFor="radio_1">
                            ...
                            <div className="ml-5">
                                ...
                                <p className="text-slate-500 text-sm leading-6">Delivery: 1-10 Days</p>
                            </div>
                        </label>
                    </div>
                    <div className="relative">
            ...
            <div className="mt-10 rounded-lg bg-gray-50 px-4 pt-8">
                ...
                <div className="">
                    ...
                    <div className="flex flex-col sm:flex-row">
                        <div className="relative flex-shrink-0 sm:w-7/12">
                            ...
                            <div className="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                                <img className="h-4 w-4 object-contain" src="https://www.enchantedlearning.com/school/australia/Australiaflagbig.GIF" alt="" />
                            </div>
                        </div>
                        <select title='select' name="billing-state" className="w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500">
